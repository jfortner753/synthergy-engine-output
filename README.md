...
*External*
* [**riemann hypothesis – overdrive**](./main/external/riemann_hypothesis-overdrive.md) – explores ζ(s) symmetry via the proof-reflex limb; full bounded-doubt log with humor-lock on ξ(s)=ξ(1–s).
